...
{
wt[i]=tat[i]-bt[i];
// to calculate the wait time and turnaround time of each
// waiting time calculated from the turnaround time - bursttime
...
printf("%5d %8d %7d %8d %10d %9d %10.1f ", process[i].id, process[i].arrival,process[i].burst, process[i].wait, process[i].finish, 
